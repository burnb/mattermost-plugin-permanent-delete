...
type Post struct {
	...
	Editat       null.Int64  `boil:"editat" json:"editat,omitempty" toml:"editat" yaml:"editat,omitempty"`
	Deleteat     null.Int64  `boil:"deleteat" json:"deleteat,omitempty" toml:"deleteat" yaml:"deleteat,omitempty"`
	Ispinned     null.Bool   `boil:"ispinned" json:"ispinned,omitempty" toml:"ispinned" yaml:"ispinned,omitempty"`
	...
	Rootid       null.String `boil:"rootid" json:"rootid,omitempty" toml:"rootid" yaml:"rootid,omitempty"`
	...
	Props        null.String `boil:"props" json:"props,omitempty" toml:"props" yaml:"props,omitempty"`
	Hashtags     null.String `boil:"hashtags" json:"hashtags,omitempty" toml:"hashtags" yaml:"hashtags,omitempty"`
	Filenames    null.String `boil:"filenames" json:"filenames,omitempty" toml:"filenames" yaml:"filenames,omitempty"`
	Fileids      null.String `boil:"fileids" json:"fileids,omitempty" toml:"fileids" yaml:"fileids,omitempty"`
	Hasreactions null.Bool   `boil:"hasreactions" json:"hasreactions,omitempty" toml:"hasreactions" yaml:"hasreactions,omitempty"`
...
var PostWhere = struct {
	...
	Editat       whereHelpernull_Int64
	Deleteat     whereHelpernull_Int64
	Ispinned     whereHelpernull_Bool
	...
	Props        whereHelpernull_String
	Hashtags     whereHelpernull_String
	Filenames    whereHelpernull_String
	Fileids      whereHelpernull_String
	Hasreactions whereHelpernull_Bool
}{
	ID:           whereHelperstring{field: "\"posts\".\"id\""},
	Createat:     whereHelpernull_Int64{field: "\"posts\".\"createat\""},
	Updateat:     whereHelpernull_Int64{field: "\"posts\".\"updateat\""},
	Editat:       whereHelpernull_Int64{field: "\"posts\".\"editat\""},
	Deleteat:     whereHelpernull_Int64{field: "\"posts\".\"deleteat\""},
	Ispinned:     whereHelpernull_Bool{field: "\"posts\".\"ispinned\""},
	Userid:       whereHelpernull_String{field: "\"posts\".\"userid\""},
	Channelid:    whereHelpernull_String{field: "\"posts\".\"channelid\""},
	Rootid:       whereHelpernull_String{field: "\"posts\".\"rootid\""},
	Parentid:     whereHelpernull_String{field: "\"posts\".\"parentid\""},
	Originalid:   whereHelpernull_String{field: "\"posts\".\"originalid\""},
	Message:      whereHelpernull_String{field: "\"posts\".\"message\""},
	Type:         whereHelpernull_String{field: "\"posts\".\"type\""},
	Props:        whereHelpernull_String{field: "\"posts\".\"props\""},
	Hashtags:     whereHelpernull_String{field: "\"posts\".\"hashtags\""},
	Filenames:    whereHelpernull_String{field: "\"posts\".\"filenames\""},
	Fileids:      whereHelpernull_String{field: "\"posts\".\"fileids\""},
	Hasreactions: whereHelpernull_Bool{field: "\"posts\".\"hasreactions\""},
}
...
var (
	postAllColumns            = []string{"id", "createat", "updateat", "editat", "deleteat", "ispinned", "userid", "channelid", "rootid", "parentid", "originalid", "message", "type", "props", "hashtags", "filenames", "fileids", "hasreactions"}
	postColumnsWithoutDefault = []string{"id", "createat", "updateat", "editat", "deleteat", "ispinned", "userid", "channelid", "rootid", "parentid", "originalid", "message", "type", "props", "hashtags", "filenames", "fileids", "hasreactions"}
