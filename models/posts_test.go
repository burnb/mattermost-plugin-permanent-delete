...
var (
	postDBTypes = map[string]string{`ID`: `character varying`, `Createat`: `bigint`, `Updateat`: `bigint`, `Editat`: `bigint`, `Deleteat`: `bigint`, `Ispinned`: `boolean`, `Userid`: `character varying`, `Channelid`: `character varying`, `Rootid`: `character varying`, `Parentid`: `character varying`, `Originalid`: `character varying`, `Message`: `character varying`, `Type`: `character varying`, `Props`: `character varying`, `Hashtags`: `character varying`, `Filenames`: `character varying`, `Fileids`: `character varying`, `Hasreactions`: `boolean`}
	_           = bytes.MinRead
)
